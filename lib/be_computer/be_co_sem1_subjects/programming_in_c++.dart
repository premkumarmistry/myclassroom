...
class ProgrammingInCPlusPlus extends StatelessWidget {
  // Google Drive Links
                  ...
                  child: Table(
                    ...
                    children: [
                      ...
                      _buildTableRowWithLinks(
                          context, "Chapter 1: Java Basics", chapter1PdfLink, chapter1PptLink),
                      _buildTableRowWithLinks(
                          context, "Chapter 2: OOP", chapter2PdfLink, chapter2PptLink),
                      _buildTableRowWithLinks(
                          context, "Chapter 3: Exception Handling", chapter3PdfLink, chapter3PptLink),
                      _buildTableRowWithLinks(
                          context, "Chapter 4: Collections Framework", chapter4PdfLink, chapter4PptLink),
                    ],
                  ),
                ),
              ),
              ...
              Center(
                child: Container(
                  ...
                  child: Table(
                    ...
                    children: [
                      _buildTableRowWithLinks(context, "Java Basics Paper", javaBasicsPaperLink),
                      _buildTableRowWithLinks(context, "OOP Paper", oopPaperLink),
                    ],
                  ),
                ),
              ),
